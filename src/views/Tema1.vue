...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Dichos principios fueron acuñados con el nombre de “Manifiesto agile” y su fundamento se halla en valores que promueven una cultura basada en la aceptación y adaptación a los cambios que sean necesarios para el progreso de una organización. Los valores mencionados priorizan:
    ...
    img.mb-5.mx-auto(src="@/assets/curso/temas/tema1/img-6.jpg" style="max-width: 610px")

    p.mb-5 Para complementar el tema se recomienda realizar las lecturas <b>Gestión Ágil de proyectos y Manifiesto por el Desarrollo Ágil de <em>Software</em></b>, que se encuentran en el material complementario.
    ...
    p.mb-5 <em>SCRUM</em> es una de las metodologías ágiles que determinan un marco de trabajo mediante el cual se pueden enfocar problemáticas y adaptar soluciones para entregar productos de la máxima calidad y valor posibles. Se basa en el control de procesos en el desarrollo de productos y se puede llevar a cabo en tres ciclos; pre game, game y pos game basado en los conocimiento y la experiencia de las personas que participan en ellos.
    ...
    p.mb-5 Después de planificar la iteración que algunos autores como Sánchez (2018) llaman Sprint, se comienza a ejecutar cada tarea de la iteración:

    PasosA.color-acento-contenido.mb-5(tipo="n")
      .row
        p Cada día se realiza una sincronización que consiste en una reunión del equipo con duración de 15 minutos frente a un tablero para autoevaluarse frente a los avances en la tarea en la que los miembros deben responder a las preguntas: 
    ...
    p Para complementar el tema, se recomienda realizar la lectura Metodología Scrum, la cual e encuentra en el material complementario.
    ...
    p.mb-5 Es un método ágil que se basa en SCRUM para el desarrollo de proyectos, es fácilmente combinable con otras metodologías ágiles por lo que es adaptable fácilmente al desarrollo de videojuegos ya que se pueden prever y administrar los riesgos, los recursos y así mismo los resultados obtenidos. Se destacan las siguientes características:
    ...
    ImagenInfografica.color-acento-botones.mb-5.col-xl-10.mx-auto.img-edit-infografia
      template(v-slot:imagen)
        figure
    ...
    p.mb-5 Se pueden distinguir los siguientes roles:
    ...
    p Para complementar el aprendizaje de este tema, se recomienda realizar la lectura SUM para el desarrollo de videos juegos, la cual se encuentra en el material complementario.
</template>
